...
public class NetworkedEventManager : NetworkBehaviour
{
    ...
    public void TriggerEvent(string gameEventKey)
    {
        if (isLocalPlayer)
        {
            CmdTriggerEvent(gameEventKey);
        }
    }

    [Command]
    void CmdTriggerEvent(string gameEventKey)
    {
